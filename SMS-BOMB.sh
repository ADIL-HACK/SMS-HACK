...
banner() {
    ...
    if ! [ -x "$(command -v toilet)" ]; then
        ...
        toilet -f mono12 -F border ADIL
    fi
    echo -e "\e[1;34m For Any Queries Join Me!!!\e[0m"
    echo -e "\e[1;32m           INSTAGRAM : https://instagram.com/m._adill \e[0m"
    echo -e "\e[4;32m   whatsapp chat : https://wa.me/919633189774?/ \e[0m"
    echo " "
    echo "NOTE: Kindly move to the PIP version Of SMS BOMB for more stability."
    echo " "
}
...
do
    ...
    echo "Press 3 To  Start MAIL Bomber (NEW)"
    ...
    if [ $ch -eq 1 ];then
        ...
        echo -e "\e[1;34m RUN SMS BOMB Again..."
        pause
        exit
    elif [ $ch -eq 5 ];then
        banner
